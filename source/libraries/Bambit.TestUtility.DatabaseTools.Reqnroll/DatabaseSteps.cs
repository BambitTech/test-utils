...
using Bambit.TestUtility.DatabaseTools.Reqnroll.Transforms;
...
////////////////////////////////////////////////////////////////////////////////////////////////////
public class DatabaseSteps(ScenarioContext context, IReqnrollOutputHelper outputHelper) : BaseSteps(context)
{
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////////
    /// <summary>   Current <see cref="IReqnrollOutputHelper"/> </summary>
    ///
    /// <value> The output helper. </value>
    ////////////////////////////////////////////////////////////////////////////////////////////////////

    protected IReqnrollOutputHelper OutputHelper { get; }=outputHelper;
    ...
    public void ExecuteQuery(IDbConnection connection, string query, Table parameters)
    {
        ...
        DataTableRow tableRow = parameters.Rows.First();
