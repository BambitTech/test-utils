...
namespace Bambit.TestUtility.DatabaseTools.Reqnroll
{
    ...
    public class BaseSteps(ScenarioContext context)
    {
        ...
        /// <summary>
        /// An instance of the <see cref="ReqnrollDatabaseStateManager"/>
        /// </summary>
        protected readonly ReqnrollDatabaseStateManager StateManager = new(context);

        /// <summary>
        /// Shortcut reference to the current <see cref="ReqnrollUtilitiesConfiguration"/>
        /// </summary>
        protected ReqnrollUtilitiesConfiguration Configuration => StateManager.Configuration;
